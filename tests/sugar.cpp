...
{
    auto datetime = maps::wrappy::call("datetime.datetime", 2003, 8, 4, 12, 30, 45);
    auto formatted = maps::wrappy::call(datetime, "isoformat");
...
{
    auto delta = maps::wrappy::call("datetime.timedelta", std::make_pair("hours", 1));
